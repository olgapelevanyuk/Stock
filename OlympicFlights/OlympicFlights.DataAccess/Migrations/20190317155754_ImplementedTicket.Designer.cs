...
namespace OlympicFlights.DataAccess.Migrations
{
    ...
    [Migration("20190317155754_ImplementedTicket")]
    partial class ImplementedTicket
    {
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.AccountManagement.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientID = 1,
                            Created = new DateTime(2019, 3, 17, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            Role = true,
                            Updated = new DateTime(2019, 3, 17, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725)
                        },
                        new
                        {
                            AccountID = 2,
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.FlightManagement.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FlightID = 1,
                            AirplaneID = 1,
                            ArriveTime = new DateTime(2019, 3, 17, 22, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            DepartureTime = new DateTime(2019, 3, 17, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725)
                        },
                        new
                        {
                            FlightID = 2,
                            AirplaneID = 2,
                            ArriveTime = new DateTime(2019, 3, 17, 17, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            DepartureTime = new DateTime(2019, 3, 17, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725)
                        },
                        new
                        {
                            FlightID = 3,
                            AirplaneID = 3,
                            ArriveTime = new DateTime(2019, 3, 17, 21, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            DepartureTime = new DateTime(2019, 3, 17, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725)
                        });
                });
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.TicketManagement.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 3, 14, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            SitNumber = 10
                        },
                        new
                        {
                            ...
                            IsPurchaseApproved = false,
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 3, 13, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            SitNumber = 30
                        },
                        new
                        {
                            ...
                            IsPurchaseApproved = false,
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 3, 15, 15, 57, 52, 424, DateTimeKind.Utc).AddTicks(725),
                            SitNumber = 40
                        });
                });
