...
namespace OlympicFlights.DataAccess.Migrations
{
    ...
    [Migration("20190418215902_FixCLientAndAppUserRelationConflict")]
    partial class FixCLientAndAppUserRelationConflict
    {
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.AirportManagement.Airport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = 3,
                            Created = new DateTime(2019, 4, 18, 21, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            IsDeleted = false,
                            Updated = new DateTime(2019, 4, 18, 21, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770)
                        },
                        new
                        {
                            AirportId = 2,
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.FlightManagement.Flight", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlightId = 1,
                            ArriveTime = new DateTime(2019, 4, 19, 4, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            DepartureTime = new DateTime(2019, 4, 18, 21, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            FlightPrice = 300m,
                            IsDeleted = false
                        },
                        new
                        {
                            FlightId = 2,
                            ArriveTime = new DateTime(2019, 4, 18, 23, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            DepartureTime = new DateTime(2019, 4, 18, 21, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            FlightPrice = 400m,
                            IsDeleted = false
                        },
                        ...
                        {
                            FlightId = 3,
                            ArriveTime = new DateTime(2019, 4, 19, 3, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            DepartureTime = new DateTime(2019, 4, 18, 21, 59, 1, 463, DateTimeKind.Utc).AddTicks(3770),
                            FlightPrice = 500m,
                            IsDeleted = false
                        });
