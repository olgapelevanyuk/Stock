...
namespace OlympicFlights.DataAccess.Migrations
{
    ...
    [Migration("20190417234232_FixedRelations")]
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.AirportManagement.Airport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = 3,
                            Created = new DateTime(2019, 4, 17, 23, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            IsDeleted = false,
                            Updated = new DateTime(2019, 4, 17, 23, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516)
                        },
                        new
                        {
                            AirportId = 2,
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.FlightManagement.Flight", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlightId = 1,
                            ArriveTime = new DateTime(2019, 4, 18, 6, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            FlightPrice = 300m,
                            IsDeleted = false
                        },
                        new
                        {
                            FlightId = 2,
                            ArriveTime = new DateTime(2019, 4, 18, 1, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            FlightPrice = 400m,
                            IsDeleted = false
                        },
                        ...
                        {
                            FlightId = 3,
                            ArriveTime = new DateTime(2019, 4, 18, 5, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 42, 29, 649, DateTimeKind.Utc).AddTicks(6516),
                            FlightPrice = 500m,
                            IsDeleted = false
                        });
