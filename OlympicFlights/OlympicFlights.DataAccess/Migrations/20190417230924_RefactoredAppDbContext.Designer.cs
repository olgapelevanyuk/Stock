...
namespace OlympicFlights.DataAccess.Migrations
{
    ...
    [Migration("20190417230924_RefactoredAppDbContext")]
    partial class RefactoredAppDbContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.AirportManagement.Airport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = 3,
                            Created = new DateTime(2019, 4, 17, 23, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            IsDeleted = false,
                            Updated = new DateTime(2019, 4, 17, 23, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549)
                        },
                        new
                        {
                            AirportId = 2,
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.ApplicationUserManagement.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.FlightManagement.Flight", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlightId = 1,
                            ArriveTime = new DateTime(2019, 4, 18, 6, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            FlightPrice = 300m,
                            IsDeleted = false
                        },
                        new
                        {
                            FlightId = 2,
                            ArriveTime = new DateTime(2019, 4, 18, 1, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            FlightPrice = 400m,
                            IsDeleted = false
                        },
                        ...
                        {
                            FlightId = 3,
                            ArriveTime = new DateTime(2019, 4, 18, 5, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            DepartureTime = new DateTime(2019, 4, 17, 23, 9, 19, 194, DateTimeKind.Utc).AddTicks(6549),
                            FlightPrice = 500m,
                            IsDeleted = false
                        });
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.ClientManagement.Client", b =>
                {
                    b.HasOne("OlympicFlights.DataAccess.ApplicationUserManagement.ApplicationUser", "User")
                        .WithMany("Clients")
