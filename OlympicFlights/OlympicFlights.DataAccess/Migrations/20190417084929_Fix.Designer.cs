            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.AccountManagement.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientID = 1,
                            Created = new DateTime(2019, 4, 17, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            Role = true,
                            Updated = new DateTime(2019, 4, 17, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911)
                        },
                        new
                        {
                            AccountID = 2,
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.FlightManagement.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FlightId = 1,
                            AirplaneID = 1,
                            ArriveTime = new DateTime(2019, 4, 17, 15, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            DepartureTime = new DateTime(2019, 4, 17, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911)
                        },
                        new
                        {
                            FlightId = 2,
                            AirplaneID = 2,
                            ArriveTime = new DateTime(2019, 4, 17, 10, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            DepartureTime = new DateTime(2019, 4, 17, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911)
                        },
                        new
                        {
                            FlightId = 3,
                            AirplaneID = 3,
                            ArriveTime = new DateTime(2019, 4, 17, 14, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            DepartureTime = new DateTime(2019, 4, 17, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911)
                        });
                });
            ...
            modelBuilder.Entity("OlympicFlights.DataAccess.TicketManagement.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 4, 14, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            SitNumber = 10
                        },
                        new
                        {
                            ...
                            IsPurchaseApproved = false,
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 4, 13, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            SitNumber = 30
                        },
                        new
                        {
                            ...
                            IsPurchaseApproved = false,
                            PriceCoefficient = 0m,
                            PurchaseTime = new DateTime(2019, 4, 15, 8, 49, 27, 949, DateTimeKind.Utc).AddTicks(2911),
                            SitNumber = 40
                        });
                });
